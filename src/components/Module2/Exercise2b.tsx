...
const USERS: User[] = [
  {
    ...
    bio: 'Frontend engineer at Acme Inc.',
  },
  {
    id: 2,
    name: 'Bob Martinez',
    ...
    <div className={styles.exercise}>
      <div className={styles.card}>
        ...
        <p className={styles.hint}>
          Edit a field, then switch users — the form keeps showing the previous user's edits instead
          of resetting.
        </p>
      ...
      <UserProfileEditor initialUser={selectedUser} />
    </div>
  )
}
