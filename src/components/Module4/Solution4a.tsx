...
function FilterInput({ onSearch }: { onSearch: (value: string) => void }) {
  ...
  return (
    <div className={styles.row}>
      ...
      <button className={`${styles.btn} ${styles.btnPrimary}`} onClick={() => onSearch(filter)}>
        Search
      </button>
    </div>
  )
  ...
  return (
    <div className={styles.exercise}>
      <div className={styles.card}>
        ...
        <FilterInput onSearch={setCommittedFilter} />
      </div>
      <div className={styles.card}>
